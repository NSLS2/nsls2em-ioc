...
epicsEnvSet("DEVICE_IP", "10.66.18.146")

epicsEnvSet("PREFIX",    "XF:03IDB-BI:")
...
dbLoadRecords("db/DAC_Setpoint.db",          "PriSys=$(PREFIX),PSC=$(RECORD)")
...
#
dbLoadTemplate ("db/RangeGainOffset.substitutions", "PriSys=$(PREFIX),PSC=$(RECORD)")
...
createPSC("CmdPort_$(RECORD)", "$(DEVICE_IP)", 7,0)
...
#
dbpf $(PREFIX){$(RECORD)}ChanA-Range-Sp 0
epicsThreadSleep 1
dbpf $(PREFIX){$(RECORD)}ChanA-Range-Sp 1
epicsThreadSleep 1
dbpf $(PREFIX){$(RECORD)}ChanA-Range-Sp 0
#
